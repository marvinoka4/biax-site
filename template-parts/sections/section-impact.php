...
<section
    ...
    <div class="main-container" id="about-us">
        <div
            ...
            <div class="lg:sticky lg:top-28">
                <div class="mb-14 space-y-2 md:max-w-[595px]">
                    <h2 data-ns-animate data-delay="0.2">How We Deliver Impact.</h2>
                </div>
            </div>
            <!-- Right: Features List -->
            <div class="stack-cards js-stack-cards w-full max-w-xl">
                <div
                    class="stack-cards__item js-stack-cards__item border-stroke-4/50 dark:border-stroke-5 bg-background-2 dark:bg-background-8 relative z-0 min-h-[170px] space-y-4 overflow-hidden rounded-[20px] border p-8">
                    <span class="inline-block">
                        <svg
                            ...
                            <path
                                ...
                                class="dark:stroke-accent stroke-black" />
                        </svg>
                    </span>
                    <div>
                        <h3 class="text-heading-5">Tailored Strategy, Real Outcomes</h3>
                        <p>Data-driven digital strategies aligned to business priorities and designed to deliver clear, measurable results.</p>
                    </div>
                </div>
                <div
                    class="stack-cards__item js-stack-cards__item border-stroke-4/50 dark:border-stroke-5 bg-background-2 dark:bg-background-8 relative z-0 min-h-[170px] space-y-4 overflow-hidden rounded-[20px] border p-8">
                    <div class="inline-block">
                        <span class="ns-shape-19 text-secondary dark:text-accent text-[52px]"> </span>
                    </div>
                    <div>
                        <h3 class="text-heading-5">Co-Creating Value</h3>
                        <p>We work as true partners, hands-on and accountable, until tangible value is achieved.</p>
                    </div>
                </div>
                <div
                    class="stack-cards__item js-stack-cards__item border-stroke-4/50 dark:border-stroke-5 bg-background-2 dark:bg-background-8 relative z-0 min-h-[170px] space-y-4 overflow-hidden rounded-[20px] border p-8">
                    ...
                    <div>
                        <h3 class="text-heading-5">Mapping the Digital Horizon</h3>
                        <p>We cut through the noise to identify what truly matters next, helping clients navigate and lead the digital future.</p>
                    </div>
                </div>
                <div
                    class="stack-cards__item js-stack-cards__item border-stroke-4/50 dark:border-stroke-5 bg-background-2 dark:bg-background-8 relative z-0 min-h-[170px] space-y-4 overflow-hidden rounded-[20px] border p-8">
                    <div class="inline-block">
                        <span class="ns-shape-17 text-secondary dark:text-accent text-[52px]"> </span>
                    </div>
                    <div>
                        <h3 class="text-heading-5">Empowering the Future</h3>
                        <p>We equip teams with the skills and confidence to sustain impact long after delivery.</p>
                    </div>
                </div>
            </div>
        </div>
